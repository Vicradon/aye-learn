...
let grantList = [
  ...
  { role: 'admin', resource: 'tutor_rights', action: 'update:any', attributes: '*' },
  { role: 'admin', resource: 'lesson', action: 'read:any', attributes: '*' },
  { role: 'admin', resource: 'lesson', action: 'update:any', attributes: '*' },
  { role: 'admin', resource: 'lesson', action: 'create:any', attributes: '*' },
  ...
  { role: 'tutor', resource: 'subject', action: 'read:own', attributes: '*' },
  { role: 'tutor', resource: 'subject', action: 'update:own', attributes: '*' },
  { role: 'tutor', resource: 'subject', action: 'delete:own', attributes: '*' },
